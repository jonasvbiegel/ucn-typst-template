...
#let basic-report(
  ...
  compact-mode: false,
  heading-color: blue,
  heading-font: "Palatino Linotype", // recommended alternatives: "Fira Sans", "Lato", "Source Sans Pro"
  body,
) = {
  ...
  body
  pagebreak()
  bibliography(style: "council-of-science-editors", "bibliograpy.bib")
  pagebreak()
  nonumber(include "bilag.typ")
}
